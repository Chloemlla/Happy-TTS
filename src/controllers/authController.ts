...
<body>
    <div class="card">
        ...
        <div class="content">
            <p class="hello">亲爱的 <strong>${username}</strong>，欢迎来到 Synapse！您的账户已创建成功。</p>
            <div class="list">
                <h3>您现在可以：</h3>
                <ul>
  ...
  public static async register(req: Request, res: Response) {
    try {
      ...
      try {
        ...
        const emailResult = await EmailService.sendHtmlEmail([email], "Synapse 邮箱验证", emailHtml);
  ...
  public static async verifyEmail(req: Request, res: Response) {
    try {
      ...
      try {
        ...
        await EmailService.sendHtmlEmail([regInfo.email], "欢迎加入 Synapse", welcomeHtml);
      } catch (e) {
  ...
  public static async sendVerifyEmail(req: Request, res: Response) {
    try {
      ...
      try {
        ...
        const emailResult = await EmailService.sendHtmlEmail([email], "Synapse 邮箱验证码", emailHtml);
  ...
  public static async forgotPassword(req: Request, res: Response) {
    try {
      ...
      try {
        ...
        const emailResult = await EmailService.sendHtmlEmail([email], "Synapse 密码重置", emailHtml);
