...
const EmailSender: React.FC<EmailSenderProps> = React.memo((props) => {
  ...
  <div style="background:#ffffffcc;backdrop-filter:blur(4px);margin:16px;border-radius:16px;box-shadow:0 8px 30px rgba(36,40,72,.08);border:1px solid rgba(255,255,255,.4);padding:24px 20px;">
    ...
    <div style="text-align:center;margin-top:16px;">
      <a href="https://tts-new.951100.xyz" style="display:inline-block;padding:10px 20px;background:linear-gradient(90deg,#6366f1,#8b5cf6);color:#fff;border-radius:999px;text-decoration:none;font-weight:600;box-shadow:0 6px 16px rgba(99,102,241,.25);">前往 Synapse</a>
    </div>
